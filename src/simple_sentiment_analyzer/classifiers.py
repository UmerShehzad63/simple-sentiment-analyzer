...
::
    ...
    >>> from simple_sentiment_analyzer.classifiers import NaiveBayesClassifier
    >>> train = [
    ...
    'pos'
    >>> blob = SimpleSentimentAnalyzer("The beer is good. But the hangover is horrible.", classifier=cl)
...
import simple_sentiment_analyzer.formats as formats
from simple_sentiment_analyzer.decorators import cached_property
from simple_sentiment_analyzer.exceptions import FormatError
from simple_sentiment_analyzer.tokenizers import word_tokenize
from simple_sentiment_analyzer.utils import is_filelike, strip_punc
...
class BaseClassifier:
    ...
    :param kwargs: Additional keyword arguments are passed to the constructor
        of the :class:`Format <simple_sentiment_analyzer.formats.BaseFormat>` class used to
