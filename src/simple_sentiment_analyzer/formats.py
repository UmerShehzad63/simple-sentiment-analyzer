...
registry like so: ::
    ...
    from simple_sentiment_analyzer import formats
...
that format. ::
    ...
    from simple_sentiment_analyzer.classifiers import NaiveBayesAnalyzer
...
from simple_sentiment_analyzer.utils import is_filelike
