...
:class:`SimpleSentimentAnalyzer <simple_sentiment_analyzer.blob.SimpleSentimentAnalyzer>`, :class:`Word <simple_sentiment_analyzer.blob.Word>`,
and :class:`WordList <simple_sentiment_analyzer.blob.WordList>` classes.
Example usage: ::

    >>> from simple_sentiment_analyzer import SimpleSentimentAnalyzer
    >>> b = SimpleSentimentAnalyzer("Simple is better than complex.")
    >>> b.tags
...
.. versionchanged:: 0.8.0
    These classes are now imported from ``simple_sentiment_analyzer`` rather than ``text.blob``.
"""  # noqa: E501
...
from simple_sentiment_analyzer.base import (
    BaseNPExtractor,
    BaseParser,
...
from simple_sentiment_analyzer.decorators import cached_property, requires_nltk_corpus
from simple_sentiment_analyzer.en import suggest
from simple_sentiment_analyzer.inflect import pluralize as _pluralize
from simple_sentiment_analyzer.inflect import singularize as _singularize
from simple_sentiment_analyzer.mixins import BlobComparableMixin, StringlikeMixin
from simple_sentiment_analyzer.np_extractors import FastNPExtractor
...
from simple_sentiment_analyzer.tokenizers import WordTokenizer, sent_tokenize, word_tokenize
from simple_sentiment_analyzer.utils import PUNCTUATION_REGEX, lowerstrip

# Wordnet interface
# NOTE: simple_sentiment_analyzer.wordnet is not imported so that the wordnet corpus can be lazy-loaded
...
def _initialize_models(
    ...
    # tokenizer may be a simple_sentiment_analyzer or an NLTK tokenizer
...
class BaseBlob(StringlikeMixin, BlobComparableMixin):
    """An abstract base class that all simple_sentiment_analyzer classes will inherit from.
    ...
    :param tokenizer: (optional) A tokenizer instance. If ``None``,
        defaults to :class:`WordTokenizer() <simple_sentiment_analyzer.tokenizers.WordTokenizer>`.
    :param np_extractor: (optional) An NPExtractor instance. If ``None``,
        defaults to :class:`FastNPExtractor() <simple_sentiment_analyzer.en.np_extractors.FastNPExtractor>`.
    :param pos_tagger: (optional) A Tagger instance. If ``None``,
        defaults to :class:`NLTKTagger <simple_sentiment_analyzer.en.taggers.NLTKTagger>`.
    :param analyzer: (optional) A sentiment analyzer. If ``None``,
        defaults to :class:`PatternAnalyzer <simple_sentiment_analyzer.en.sentiments.PatternAnalyzer>`.
    :param parser: A parser. If ``None``, defaults to
        :class:`PatternParser <simple_sentiment_analyzer.en.parsers.PatternParser>`.
    ...
    def pos_tags(self):
        ...
        """
        if isinstance(self, SimpleSentimentAnalyzer):
            return [
                val
...
class SimpleSentimentAnalyzer(BaseBlob):
    ...
    :param tokenizer: (optional) A tokenizer instance. If ``None``, defaults to
        :class:`WordTokenizer() <simple_sentiment_analyzer.tokenizers.WordTokenizer>`.
    :param np_extractor: (optional) An NPExtractor instance. If ``None``,
        defaults to :class:`FastNPExtractor() <simple_sentiment_analyzer.en.np_extractors.FastNPExtractor>`.
    :param pos_tagger: (optional) A Tagger instance. If ``None``, defaults to
        :class:`NLTKTagger <simple_sentiment_analyzer.en.taggers.NLTKTagger>`.
    :param analyzer: (optional) A sentiment analyzer. If ``None``, defaults to
        :class:`PatternAnalyzer <simple_sentiment_analyzer.en.sentiments.PatternAnalyzer>`.
...
class Blobber:
    """A factory for SimpleSentimentAnalyzers that all share the same tagger,
    tokenizer, parser, classifier, and np_extractor.

    Usage:

        >>> from simple_sentiment_analyzer import Blobber
        >>> from simple_sentiment_analyzer.taggers import NLTKTagger
        >>> from simple_sentiment_analyzer.tokenizers import SentenceTokenizer
    ...
    def __call__(self, text):
        """Return a new SimpleSentimentAnalyzer object with this Blobber's ``np_extractor``,
        ``pos_tagger``, ``tokenizer``, ``analyzer``, and ``classifier``.

        :returns: A new :class:`SimpleSentimentAnalyzer <SimpleSentimentAnalyzer>`.
        """
