...
from simple_sentiment_analyzer._text import CHUNK, PENN, PNP, POS, UNIVERSAL, WORD, Lexicon, Spelling
from simple_sentiment_analyzer._text import Parser as _Parser
from simple_sentiment_analyzer._text import Sentiment as _Sentiment
