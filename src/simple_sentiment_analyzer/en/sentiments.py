...
from simple_sentiment_analyzer.base import CONTINUOUS, DISCRETE, BaseSentimentAnalyzer
from simple_sentiment_analyzer.decorators import requires_nltk_corpus
from simple_sentiment_analyzer.en import sentiment as pattern_sentiment
