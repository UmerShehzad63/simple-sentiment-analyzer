#!/usr/bin/env python
"""Downloads the necessary NLTK corpora for SimpleSentimentAnalyzer.

Usage: ::

    $ python -m simple_sentiment_analyzer.download_corpora

If you only intend to use SimpleSentimentAnalyzer's default models, you can use the "lite"
option: ::

    $ python -m simple_sentiment_analyzer.download_corpora lite
